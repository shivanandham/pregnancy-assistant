...
router.get('/tips/:week', HomeController.getTipsForWeek);

// GET /api/home/milestones/:week - Get milestones for a specific week
router.get('/milestones/:week', HomeController.getMilestonesForWeek);

// GET /api/home/checklist/generate - Generate dynamic checklist for a specific date
router.get('/checklist/generate', HomeController.generateDynamicChecklist);

// GET /api/home/checklist/completions/:date - Get checklist completions for a specific date
router.get('/checklist/completions/:date', HomeController.getChecklistCompletions);

// GET /api/home/checklist/:week - Get daily checklist for a specific week
router.get('/checklist/:week', HomeController.getChecklistForWeek);

// POST /api/home/clear-tips - Clear expired tips (maintenance)
router.post('/clear-tips', HomeController.clearExpiredTips);

// POST /api/home/checklist/:checklistItemId/toggle - Toggle checklist item completion
router.post('/checklist/:checklistItemId/toggle', HomeController.toggleChecklistCompletion);
